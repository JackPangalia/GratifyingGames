    ...
    <>
      <main className = "bg-gray-900">
        <header className = "flex justify-center">
          <h1 className = "text-red-400 text-4xl mt-10 font-bold">About Us</h1>
          
        </header>

        <div className = "h-fit lg:h-screen mt-20">

          <div className = "text-center m-auto w-1/3 ">
            <p className = "text-xl text-white">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quia quasi illum officiis, corrupti sunt numquam! Lorem ipsum dolor sit amet.</p>
          </div>

          <section className = "flex h-full mt-20 flex-col lg:flex-row items-center lg:items-start space-y-10 lg:space-y-0 lg:space-x-10 mr-6 ml-6">
            <div className = "mt-20bg-cover  lg:w-1/2 w-full lg:h-1/2 bg-gray-800 border border-red-400 rounded-xl flex justify-center items-center flex-col text-center h-fit bg-[url('https://media.istockphoto.com/id/1281085673/photo/closeup-of-abstract-colorful-fluid-background-highly-textured-high-quality-details.jpg?s=170667a&w=0&k=20&c=ns8UQ8W6iFo5AYXNXAJx8Itjfmvs3ZwoCYwMqwr4Ers=')]">
