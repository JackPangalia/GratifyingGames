  ...
  return (
    <>
      ...
      <section className = "h-screen bg-gray-900 flex justify-center  ">
        <div className = "mt-20 rounded-xl  flex bg-cover justify-center text-center items-center w-5/6 h-4/5 flex-col bg-[url('https://images.hdqwalls.com/wallpapers/planet-space-art-ka.jpg')]">
          ...
          <div className = "mt-10 sm:space-x-5 flex sm:flex-row flex-col text-center">
            <Link href = "#" className = " font-bold pr-12 pl-12 pt-4 pb-4 hover:bg-white hover:text-red-400 bg-red-400 rounded-3xl mt-10 text-white ">Learn more</Link>
            <Link href = "#" className = " font-bold pr-12 pl-12 pt-4 pb-4 hover:bg-white hover:text-red-400 bg-red-400 rounded-3xl mt-10 text-white">Download Now</Link>
          </div>
        </div>
      </section>

      <section className = "h-screen bg-gray-900 flex justify-center items-center">
        <div className = "rounded-xl flex bg-cover justify-center items-center text-center w-5/6 h-4/5 flex-col bg-[url('https://4kwallpapers.com/images/walls/thumbs_3t/3792.jpg')]">
