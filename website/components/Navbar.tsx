...
{
  return (
    <nav className = "flex justify-center flex-wrap bg-gray-900 p-6 w-screen ">
      ...
      <div className = "w-full block flex-grow sm:flex sm:items-center sm:w-auto">
        ...
        <div className = "sm:inline-block flex-col mt-4 md:mt-0  py-3 w-full sm:w-1/3 mr-10">
          <input className = "p-3 rounded-xl text-center text-red-400 bg-gray-800 w-full " type = "text" placeholder="Search"></input>
        </div>
      </div>
